...
import torch
import warnings
from experiments.mutlimodal.runner import run_experiment_v1
from experiments.mutlimodal.config import DEFAULT_EXPERIMENTS_V1
...
def main() -> None:
    ...
    if args.list_experiments:
        ...
        for cfg in DEFAULT_EXPERIMENTS_V1:
    ...
    if not experiments:
        available = [c.name for c in DEFAULT_EXPERIMENTS_V1]
    ...
    for cfg in experiments:
        set_seed(args.seed)
        result = run_experiment_v1(cfg, args, device, output_dir)
