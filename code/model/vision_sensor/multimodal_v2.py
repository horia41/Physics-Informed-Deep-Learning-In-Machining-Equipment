...
from constants.vision_sensor_constants import BACKBONE_FEATDIM, BACKBONE_NAME, VALID_FUSION_MODES_V2
from model.vision_sensor.fusion import SensorEncoder
...
class MATWIMultimodalModelV2(nn.Module):
    """
    ...
    def __init__(
        ...
        if use_sensors and fusion_mode not in VALID_FUSION_MODES_V2:
            raise ValueError(
                f"fusion_mode must be one of {VALID_FUSION_MODES_V2}, got '{fusion_mode}'"
            )
