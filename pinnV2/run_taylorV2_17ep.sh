#!/bin/bash
# ============================================================================
# MATWI Stage 3 (pinnV2 = WITH the taylor_intercept_um fix) — 17 epochs
# ============================================================================
# Tests the FIXED use_taylor_slope=True path across lambda {0.05, 0.1, 0.5},
# 3 seeds, vs matched controls. Observed-slope (False) is unchanged by the fix
...
#
#   mkdir -p /scratch-shared/hionescu/project_pinn/pinnV2/runs/confirm/logs
#   sbatch /scratch-shared/hionescu/project_pinn/pinnV2/run_taylorV2_17ep.sh
# ============================================================================
#
#SBATCH --job-name=taylorV2_17
...
#SBATCH --array=0-23
#SBATCH --output=/scratch-shared/hionescu/project_pinn/pinnV2/runs/confirm/logs/v2_%A_%a.out
#SBATCH --error=/scratch-shared/hionescu/project_pinn/pinnV2/runs/confirm/logs/v2_%A_%a.err
