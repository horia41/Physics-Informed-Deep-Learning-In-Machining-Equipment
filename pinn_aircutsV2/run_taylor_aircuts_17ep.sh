...
#   mkdir -p /scratch-shared/hionescu/project_pinn/pinn_aircutsV2/runs/aircuts/logs
#   sbatch /scratch-shared/hionescu/project_pinn/pinn_aircutsV2/run_taylor_aircuts_17ep.sh
# ============================================================================
#
...
#SBATCH --array=0-11
#SBATCH --output=/scratch-shared/hionescu/project_pinn/pinn_aircutsV2/runs/aircuts/logs/ac_%A_%a.out
#SBATCH --error=/scratch-shared/hionescu/project_pinn/pinn_aircutsV2/runs/aircuts/logs/ac_%A_%a.err
