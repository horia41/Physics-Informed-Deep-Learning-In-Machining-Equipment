#!/bin/bash
# ============================================================================
# MATWI Stage 3 (pinnV3) — HIGH-lambda add-on, 17 epochs
# ============================================================================
# Extends the lambda ladder upward for the two Taylor-slope variants. No
# controls (already from run_taylorV3_17ep.sh). Writes into the SAME pinnV3
# confirm/ dirs so aggregate_confirm.py folds these into the existing rows.
#
#   cells (i//3):
...
#
#   sbatch /scratch-shared/hionescu/project_pinn/pinnV3/run_taylorV3_17ep_highlam.sh
# (runs/confirm/logs already exists from the previous batch)
# ============================================================================
#
#SBATCH --job-name=taylorV3_hi
...
#SBATCH --array=0-17
#SBATCH --output=/scratch-shared/hionescu/project_pinn/pinnV3/runs/confirm/logs/v3hi_%A_%a.out
#SBATCH --error=/scratch-shared/hionescu/project_pinn/pinnV3/runs/confirm/logs/v3hi_%A_%a.err
