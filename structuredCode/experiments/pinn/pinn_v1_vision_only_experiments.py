...
from experiments.vision_only_experiment import build_loaders, evaluate, ExperimentConfig
...
def _train_one_epoch_taylor_vision_only(model, loader, optimizer, scheduler, data_criterion,
...
def run_experiment_vision_only(cfg: Stage3Config, args, device, out_dir: Path) -> dict:
    ...
    for epoch in range(1, cfg.epochs + 1):
        t0 = time.time()
        tr = _train_one_epoch_taylor_vision_only(model, loaders["train"], optimizer, scheduler,
