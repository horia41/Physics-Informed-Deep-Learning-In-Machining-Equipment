...
# The task-3 grid (ALL_EXPERIMENTS / t3_gated_top25_md30) lives in
# train_vision_sensorV2.py, NOT the Stage-2 train_vision_sensor.py. Search the V2
# name first; the bare Stage-2 file is a last resort and is rejected below.
...
if not hasattr(_TVS, "ALL_EXPERIMENTS"):
    raise SystemExit(
        ...
        "Use train_vision_sensorV2.py (the file containing 't3_gated_top25_md30').\n"
        "Ensure vision-sensor/improve_attempt/train_vision_sensorV2.py exists, or copy "
        "it (+ modelVisionSensorV2.py + DatasetClass_VisionSensors.py) into pinnV3/.\n"
